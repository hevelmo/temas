$(function() {
	...
	$("#emailframe").load(function() {
		...
		*/
		...
		/* ---  text edit mouseover --- */
		$($("#emailframe").contents().find('body')).on("mouseenter", '.editable_text', function(e) {
		...
		}).on("mouseleave", '.editable_text', function(e) {
		...
		*/
		...
		$($("#emailframe").contents().find('body')).on("mouseenter", '.editable_img', function(e) {
		...
		}).on("mouseleave", '.editable_img', function(e) {
	...
	function updateBodyColor(color) {
		$($("#emailframe").contents().find('.body_color')).css("background-color", color.toHexString());
	}
	...
	$("#colorpicker7").spectrum({
		...
		chooseText: "select",
		move: function(color) {
			updateWhiteColor(color);
		},
		change: function(color) {
			updateWhiteColor(color);
		}
	});
	function updateWhiteColor(color) {
	...
	$(".save-template").on("click",function(e){
		...
		var htmlcontent = $("#emailframe").contents().find(".container").html();
